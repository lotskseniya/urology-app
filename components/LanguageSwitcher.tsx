  ...
  return (
    <div className='relative inline-block'>
      ...
      <div className='flex relative'>
        <Link
          href="/uk"
          className={`relative px-2.5 py-1 text-xs font-semibold uppercase transition-colors cursor-pointer ${
            currentLocale === 'uk' ? 'text-[#7B3F3F]' : 'text-[#8B4545]'
          }`}
          style={{ 
        ...
        <Link
          href="/en"
          className={`relative px-2.5 py-1 text-xs font-semibold uppercase transition-colors cursor-pointer ${
            currentLocale === 'en' ? 'text-white' : 'text-black'
          }`}
          style={{ 
